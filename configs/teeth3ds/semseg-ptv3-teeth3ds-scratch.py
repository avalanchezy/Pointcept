...
# misc custom setting
batch_size = 32  # single GPU (matches sonata config)
num_worker = 32
mix_prob = 0.8
clip_grad = 3.0
empty_cache = False
...
# scheduler settings (Standard PTv3 scratch training)
epoch = 200  # Same as Sonata fine-tuning (dataset is small)
...
# hooks (Standard PTv3 hooks - no CheckpointLoader)
hooks = [
